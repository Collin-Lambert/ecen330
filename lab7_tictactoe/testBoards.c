...
void testBoards() {
  ...
  tictactoe_board_t board16;
  board16.squares[TOP][LFT] = MINIMAX_X_SQUARE;
  board16.squares[TOP][MID] = MINIMAX_X_SQUARE;
  board16.squares[TOP][RGT] = MINIMAX_O_SQUARE;
  board16.squares[MID][LFT] = MINIMAX_O_SQUARE;
  board16.squares[MID][MID] = MINIMAX_O_SQUARE;
  board16.squares[MID][RGT] = MINIMAX_X_SQUARE;
  board16.squares[BOT][LFT] = MINIMAX_X_SQUARE;
  board16.squares[BOT][MID] = MINIMAX_EMPTY_SQUARE;
  board16.squares[BOT][RGT] = MINIMAX_EMPTY_SQUARE;

  tictactoe_board_t board17;
  ...
  board17.squares[MID][RGT] = MINIMAX_X_SQUARE;
  board17.squares[BOT][LFT] = MINIMAX_X_SQUARE;
  board17.squares[BOT][MID] = MINIMAX_O_SQUARE;
  ...
  printf("\nboard16 Os turn:\n");
  move = minimax_computeNextMove(&board16, !is_Xs_turn);
  printf("next move for board16: (%d, %d)\n", move.row, move.column);

  printf("\nboard17 Xs turn:\n");
  move = minimax_computeNextMove(&board17, is_Xs_turn);
